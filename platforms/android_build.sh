...
scripts/cmake_android_arm.sh -DANDROID_STL=c++_shared -DBUILD_SHARED_LIBS=ON -DENABLE_LTO=ON -DCMAKE_BUILD_TYPE=RELEASE -DBUILD_ZLIB=ON -DWITH_JAVA=ON -DANDROID_NATIVE_API_LEVEL=14 -DANDROID_ABI=$ARCH -DANDROID_TOOLCHAIN_NAME=x86-4.9
